 ...
 * @author Admin
 */
@WebServlet(name = "ViewAllCakesController", urlPatterns = {"/ViewAllCakesController"})
public class ViewAllCakesController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch (role) {
                case "admin":
                    cakes = blo.getAllCakes();
                    break;

                default:
                    cakes = blo.getAllAvailableCakes();
                    break;
            }

            // not to forget set orderDetailsCollection null
            ...
            log("ERROR at ViewAllCakesController: " + e.getMessage());
        } finally {
