...
public class UpdateCakeController extends HttpServlet {
    ...
    private static final String UPDATE_CAKE_PAGE = "viewCakePage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = myProperties.getMyProperty(UPDATE_CAKE_PAGE);
        ...
        try {
            ...
            if (isMultiPart) {
                ...
                if (img == null) {
                    img = (String) params.get("oldImage");
                }
                ...
                cake = new Cake(idCake, nameCake, imageCake, price,
                        descCake, createDate, expirationDate, quantity, status, new Category(idCategory));
                ...
                if (blo.updateCake(cake)) {
                    ...
                    request.setAttribute("MESSAGE", "Failed to update " + idCake);
