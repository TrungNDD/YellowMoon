...
public class TrackOrderController extends HttpServlet {
    private static final String TRACK_ORDER_PAGE = "trackOrderPage";
    /** 
    ...
    throws ServletException, IOException {
        ...
        String url = myProperties.getMyProperty(TRACK_ORDER_PAGE);
               
        try {
            TblOrderBLO blo = new TblOrderBLO();
            List<TblOrder> orders = blo.getAllOrder(account);
