 ...
 * @author Admin
 */
@WebServlet(name="ViewCakeController", urlPatterns={"/ViewCakeController"})
public class ViewCakeController extends HttpServlet {
    private static final String VIEW_CAKE_PAGE = "viewCakePage";
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            cake = blo.getCakeById(idCake);
            
            if (cake != null) {
                request.setAttribute("CAKE", cake);
                url = myProperties.getMyProperty(VIEW_CAKE_PAGE);
            } else{
                request.setAttribute("MESSAGE", "Can't load " + idCake);
            }
        } catch (Exception e) {
            log("ERROR at ViewCakeController: " + e.getMessage());
        } finally {
